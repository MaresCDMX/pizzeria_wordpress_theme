...
Plugin URI: 
Description: Plugin para crear un custom post type de especialidades
Version: 1.0.0
Author: Jesús Mares
...
/** Agregar campos a la resuesta REST API */
...
register_rest_field( 'especialidades', 'precio', array(
  ...
  register_rest_field( 'especialidades', 'categoria_menu', array(
    'get_callback' => 'lapizzeria_taxonomia_menu',
    'update_callback' => null,
    'schema' => null,
  ) );
  register_rest_field( 'especialidades', 'imagen_destacada', array(
    'get_callback' => 'lapizzeria_imagen_obtener_destacada',
    'update_callback' => null,
    'schema' => null,
  ) );
}
...
function lapizzeria_imagen_obtener_destacada ($object, $field_name, $request) {
